...
class SmartModel(nn.Module):
    def __init__(self, num_classes):
        ...
        self.single_frame_selector = SingleFrameSelector(input_dim=1280, num_classes=num_classes)
    ...
    def forward(self, x):
        ...
        with torch.no_grad():
            ...
            features = features.view(features.size(0), features.size(1), -1)  # 调整特征形状以匹配选择器的输入
